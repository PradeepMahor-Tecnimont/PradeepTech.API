--------------------------------------------------------
--  DDL for Function WORKEDHRS1
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SELFSERVICE"."WORKEDHRS1" (V_Code IN Varchar2, V_PDate IN Date, V_ShiftCode IN Varchar2) Return Number IS
