--------------------------------------------------------
--  DDL for Function DM_IS_USER_RESIGN
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SELFSERVICE"."DM_IS_USER_RESIGN" 
(
...
begin
  ...
  If v_count > 0 Then
    ...
    if v_count = 1 Then --IF user LEFT TICB
        return 1; -- User resigned
    else
        return -1; -- User Not resigned
    end if;
  end if;
end dm_is_user_resign;
