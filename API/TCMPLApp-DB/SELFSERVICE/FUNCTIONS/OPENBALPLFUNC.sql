--------------------------------------------------------
--  DDL for Function OPENBALPLFUNC
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SELFSERVICE"."OPENBALPLFUNC" (V_EmpNo IN Varchar2, V_OpBalDtFrom IN Date, V_OpenBal IN Number,
												V_PL Out Number, V_Tot OUT Number) Return number IS
	VCount number;
	VCount1 number;
	VCount2 number;
	VCount3 number;
