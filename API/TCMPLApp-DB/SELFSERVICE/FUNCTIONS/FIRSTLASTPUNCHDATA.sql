--------------------------------------------------------
--  DDL for Function FIRSTLASTPUNCHDATA
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SELFSERVICE"."FIRSTLASTPUNCHDATA" (EmpNum IN Varchar2, PunchDate IN Date,FirstLast In Number) RETURN number IS
	Cursor C1 is select * from SS_Punch 
		where EmpNo = ltrim(rtrim(EmpNum))
		and PDate = PunchDate order by PDate,hh,mm,ss;
