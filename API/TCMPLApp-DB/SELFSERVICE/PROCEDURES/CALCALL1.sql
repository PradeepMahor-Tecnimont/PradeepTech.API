--------------------------------------------------------
--  DDL for Procedure CALCALL1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SELFSERVICE"."CALCALL1" (EmpNum IN Varchar2, V_PDate IN Date, ITime OUT Number, V_ITime OUT Varchar2,
...
BEGIN
		...
		ElsIf IsHoliday = 0 then
			...
			--EstHrs := (((OTimeHH*60) + OTimeMn) - ((ITimeHH * 60) + ITimeMn) - (V_EstimatedLunchTime - V_AvailedLunchTime));
