...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TRIGGER "SELFSERVICE"."TRIG_DESKALLOCATION_LOG" 
AFTER INSERT OR DELETE ON XDM_DESKALLOCATION_05DEC16 
...
/
ALTER TRIGGER "SELFSERVICE"."TRIG_DESKALLOCATION_LOG" ENABLE;
