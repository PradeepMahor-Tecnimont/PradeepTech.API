--------------------------------------------------------
--  DDL for Package Body IOT_EXTRAHOURS
--------------------------------------------------------
...
Create Or Replace Package Body selfservice.iot_extrahours As
    ...
    Procedure sp_create_claim(
        ...
        p_confirmation_status   Varchar2 Default not_ok,
    ...
    Begin
        ...
        If p_confirmation_status != ok And sysdate <= v_end_date Then
            p_message_type := 'KO';
            p_message_text := 'Please check the checkbox first if you want to claim current month extra hours.';
            Return;
        End If;
    ...
    Begin
        ...
        Where
            ...
            And hrd_apprl = -1; -- disapproved

        If v_count = 0 Then
            p_message_type := not_ok;
            p_message_text := 'Err - Incorrect application id provided.';
            Return;
        End If;
        Update
            ss_otmaster
...
/
  ...
  Grant Execute On selfservice.iot_extrahours To tcmpl_app_config;