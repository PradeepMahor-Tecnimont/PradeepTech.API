--------------------------------------------------------
--  DDL for Package Body XLSX_READ
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SELFSERVICE"."XLSX_READ" 
is
--
...
--
  ...
  Function get_blob ( param_id varchar2 ) Return Blob Is
        v_blob Blob;
    Begin
        Select
            blob_field
...
/
  ...
  GRANT EXECUTE ON "SELFSERVICE"."XLSX_READ" TO "TCMPL_APP_CONFIG";
