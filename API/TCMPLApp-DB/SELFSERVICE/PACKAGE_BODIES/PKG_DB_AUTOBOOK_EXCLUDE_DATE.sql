Create Or Replace Package Body "SELFSERVICE"."PKG_DB_AUTOBOOK_EXCLUDE_DATE" As
...
/
Grant Execute On "SELFSERVICE"."PKG_DB_AUTOBOOK_EXCLUDE_DATE" To "TCMPL_APP_CONFIG";