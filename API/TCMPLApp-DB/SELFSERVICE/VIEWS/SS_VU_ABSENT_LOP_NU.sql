--------------------------------------------------------
--  DDL for View SS_VU_ABSENT_LOP_NU
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SELFSERVICE"."SS_VU_ABSENT_LOP_NU" ("EMPNO", "NAME", "PARENT", "ASSIGN", "PAYSLIP_YYYYMM", "ABSENT_YYYYMM", "LOP_DAYS_CSV", "EMP_TOT_LOP", "REVERSE_LOP_DAYS_CSV") AS 
  select
     a.empno,
     b.name,
     b.parent,
