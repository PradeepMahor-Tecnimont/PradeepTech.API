...
CREATE OR REPLACE PACKAGE "IOT_LEAVE_QRY" As
    ...
    c_pending Constant Number := ss.pending;
    c_approved Constant Number := ss.approved;
    c_apprl_none Constant Number := ss.apprl_none;
            ...
            From
                (
                    Select
                        ...
                        Row_Number() Over (Order By app_date_4_sort Desc) As row_number,
...
--IOT_PRINT_LOG_QRY
---------------------------
CREATE OR REPLACE PACKAGE BODY "IOT_PRINT_LOG_QRY" As
