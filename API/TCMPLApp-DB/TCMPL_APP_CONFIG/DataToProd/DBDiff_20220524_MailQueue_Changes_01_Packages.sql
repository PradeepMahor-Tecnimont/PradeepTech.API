...
--APP_MAIL_QUEUE
---------------------------
ALTER TABLE "TCMPL_APP_CONFIG"."APP_MAIL_QUEUE" ADD ("MAIL_ATTACHMENTS_BUSINESS_NAME" VARCHAR2(4000));
ALTER TABLE "TCMPL_APP_CONFIG"."APP_MAIL_QUEUE" ADD ("MAIL_ATTACHMENTS_OS_NAME" VARCHAR2(4000));
ALTER TABLE "TCMPL_APP_CONFIG"."APP_MAIL_QUEUE" DROP ("MAIL_ATTACHMENTS");

---------------------------
--Changed TABLE
--APP_MAIL_SENT
---------------------------
ALTER TABLE "TCMPL_APP_CONFIG"."APP_MAIL_SENT" ADD ("MAIL_ATTACHMENTS_BUSINESS_NAME" VARCHAR2(4000));
ALTER TABLE "TCMPL_APP_CONFIG"."APP_MAIL_SENT" ADD ("MAIL_ATTACHMENTS_OS_NAME" VARCHAR2(4000));
ALTER TABLE "TCMPL_APP_CONFIG"."APP_MAIL_SENT" DROP ("MAIL_ATTACHMENTS");
