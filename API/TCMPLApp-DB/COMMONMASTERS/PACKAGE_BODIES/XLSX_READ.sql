...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE BODY "COMMONMASTERS"."XLSX_READ" 
is
--
...
--
  ...
  Function get_blob ( param_id Number ) Return Blob Is
        v_blob Blob;
    Begin
        Select
            blob_field
...
/
  ...
  GRANT EXECUTE ON "COMMONMASTERS"."XLSX_READ" TO PUBLIC;
