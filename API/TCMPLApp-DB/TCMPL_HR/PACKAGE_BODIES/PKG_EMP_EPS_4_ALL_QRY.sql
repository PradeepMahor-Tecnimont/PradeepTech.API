Create Or Replace Package Body "TCMPL_HR"."PKG_EMP_EPS_4_ALL_QRY" As

    Function fn_get_emp_eps_4_all_list(
    ...
    Begin
        ...
        Return fn_get_emp_eps_4_all_list(
                p_empno       => v_empno,
    ...
    Function fn_4hr_emp_eps_4_all_list(
        p_person_id   Varchar2,
        p_meta_id     Varchar2,
        p_empno       Varchar2,
        p_row_number  Number,
    ...
    End fn_4hr_emp_eps_4_all_list;

End pkg_emp_eps_4_all_qry;
/
 Grant Execute On   "TCMPL_HR"."PKG_EMP_EPS_4_ALL_QRY"  To "TCMPL_APP_CONFIG";