...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE BODY "TCMPL_HR"."SCHEMA_OBJECTS" As
    ...
    Begin
        For obj In cur_schema_objs Loop
            If obj.obj_priv Is Not Null Then
                Execute Immediate 'Grant ' || obj.obj_priv || ' on ' || obj.object_name || ' to tcmpl_app_config';
...
/
  ...
  GRANT EXECUTE ON "TCMPL_HR"."SCHEMA_OBJECTS" TO "TCMPL_APP_CONFIG";
