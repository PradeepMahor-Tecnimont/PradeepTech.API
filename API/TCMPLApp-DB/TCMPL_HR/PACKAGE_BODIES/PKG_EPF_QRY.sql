Create Or Replace Package Body "TCMPL_HR"."PKG_EPF_QRY" As

    Function fn_get_epf_list(
...
End pkg_epf_qry;
/
 Grant Execute On   "TCMPL_HR"."PKG_EPF_QRY"  To "TCMPL_APP_CONFIG";