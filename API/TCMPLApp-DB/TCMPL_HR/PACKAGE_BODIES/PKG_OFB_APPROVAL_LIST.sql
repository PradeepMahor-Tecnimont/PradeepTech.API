Create Or Replace Package Body "TCMPL_HR"."PKG_OFB_APPROVAL_LIST" As
    ...
    Begin
                ...
                From
                    (
                        With
                            pending_min_ofb As (
                                Select
                                    oeea1.empno, Min(oeea1.sort_order) sort_order
                                From
                                    ofb_emp_exit_approvals oeea1
                                Where
                                    nvl(oeea1.is_approved, not_ok) = not_ok
                        ...
                        Select
                            ...
                            oeea.is_approved,
                            pkg_ofb_common.fn_get_action_desc(oeea.apprl_action_id)                 My_Approval_Action,
                        ...
                        Where
                            ...
                            And nvl(oeea.is_approved, not_ok) = not_ok
                            And oeea.empno                    = pmo.empno
                            And oeea.sort_order               = pmo.sort_order
        ...
        End If;
        Return c;
    End fn_ofb_approval_list;

    Function fn_pending_list(
        p_person_id      Varchar2,
        p_meta_id        Varchar2,
        ...
        Open c For
            ...
            From
                (
                    Select
                        aa.*,
                        Row_Number() Over (Order By aa.relieving_date Desc, aa.empno) row_number,
                        Count(*) Over ()                                              total_row
                    ...
                    From
                        (
                            ...
                            Select
                                ...
                                a.action_id,
                                a.apprl_action_id,
                                pkg_ofb_common.fn_get_action_desc(a.apprl_action_id)              action_desc,
                                x.relieving_date,

                                x.remarks                                                         initiator_remarks,
                                pkg_ofb_common.fn_check_rollback_ofb(a.empno, x.created_on) is_rollback_initiated,
                                a.is_approved,
                                Case nvl(a.is_approved, not_ok)
                                    ...
                                    Else
                                        'Pending'
                                End                                                               approval_status,
                                    pkg_ofb_approval.fn_is_approval_due(a.empno, a.apprl_action_id)   is_apprl_due
                            From
                                ...
                                ofb_emp_exits          x
                            Where
                                a.apprl_action_id In (
                                    Select
                                        ra.action_id
                                    From
                                        ofb_vu_module_user_role_actions ra
                                    Where
                                        ra.empno         = v_approver_empno
                                        And ra.module_id = c_module_id
                                        And ra.action_id <> c_hod_apprl_action
                                )
                                And e.empno                    = a.empno
                                And e.parent                   = c.costcode
                                And x.empno                    = a.empno
                                And nvl(a.is_approved, not_ok) != ok
                            Union All
                            ...
                            Where
                                ...
                                And x.empno                    = a.empno
                                And nvl(a.is_approved, not_ok) != ok
                                And c.hod                      = v_approver_empno
                        ) aa
                    Where
                        (
                            upper(empno) Like v_generic_search Or
                            upper(emp_name) Like v_generic_search Or
                            upper(parent) Like v_generic_search Or
                            upper(parent_name) Like v_generic_search
                        )
                        ...
                        (
                            ...
                            Select
                                ...
                                Case nvl(a.is_approved, not_ok)
                                    ...
                                    Else
                                        'Pending'
                                End                                                               my_approval_action,

                                Case pkg_ofb_approval.fn_is_approval_complete(a.empno)
                                    When ok Then
                                        'Approved'
                                    When 'OO' Then
                                        'OnHold'
    ...
    Begin
        ...
        SELECT  TO_DATE('01-01-'|| P_Start_Year , 'dd-mm-YYYY') start_year ,
            ...
            From
                (
                    ...
                    From
                        (
                             ...
                             Select
                                ...
                                pkg_ofb_common.fn_get_action_desc(a.apprl_action_id)              action_desc,
                                x.relieving_date,                                
                                a.remarks                                                         exit_approval_remarks ,
                                x.remarks                                                         initiator_remarks,
                                pkg_ofb_common.fn_check_rollback_ofb(a.empno, x.created_on) is_rollback_initiated,
                                a.is_approved,
                                Case nvl(a.is_approved, not_ok)
                            ...
                            Where
                                ...
                                And e.parent = c.costcode
                                And x.empno  = a.empno
                                and (x.relieving_date >= v_start_year and  x.relieving_date <= v_end_year)
                            Union All
                    ...
                    Where
                        (
                            upper(empno) Like v_generic_search Or
                            upper(employee_name) Like v_generic_search Or
                            upper(parent) Like v_generic_search Or
                            upper(department_Name) Like v_generic_search
                        )
                )           
            Order By
                relieving_date Desc,
