...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TRIGGER "DM_ASSETCODE_NO_USE" 
before update of scrap,scrap_date,out_of_service on DM_ASSETCODE_OLD 
...
/
ALTER TRIGGER "DM_ASSETCODE_NO_USE" ENABLE;
