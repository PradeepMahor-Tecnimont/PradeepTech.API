--------------------------------------------------------
--  DDL for Package Body PKG_BG_PROJ_DIR_MAST_QRY
--------------------------------------------------------

Create Or Replace Package Body tcmpl_afc."PKG_BG_PROJ_DIR_MAST_QRY" As

    Function fn_proj_dir_mast(
        p_person_id   Varchar2,
        p_meta_id     Varchar2,

        p_proj_dir_id Varchar2 Default Null,
    ...
    Begin
        Open c For
            ...
            From
                (
                    Select
                        a.projdirlid                                        As application_id,
                        a.empno                                             As empno,
                        ...
                        Row_Number() Over (Order By a.projdirlid Desc)      row_number,
                        Count(*) Over ()                                    total_row
                    From
                        bg_proj_dir_mast                    a, bg_company_mast b
                    Where
                        a.compid         = b.compid
                        And a.projdirlid = nvl(p_proj_dir_id, a.projdirlid)
        ...
        Return c;
    End fn_proj_dir_mast;

    Procedure sp_proj_dir_mast_details(
        p_person_id        Varchar2,
        p_meta_id          Varchar2,

        p_proj_dir_id      Varchar2,
    ...
    End sp_proj_dir_mast_details;

End pkg_bg_proj_dir_mast_qry;
/
Grant Execute On "TCMPL_AFC"."PKG_BG_PROJ_DIR_MAST_QRY" To "TCMPL_APP_CONFIG";