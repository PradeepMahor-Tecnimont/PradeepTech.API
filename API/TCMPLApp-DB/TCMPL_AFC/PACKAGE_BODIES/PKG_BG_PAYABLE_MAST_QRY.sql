--------------------------------------------------------
--  DDL for Package Body PKG_BG_PAYABLE_MAST_QRY
--------------------------------------------------------

Create Or Replace Package Body tcmpl_afc."PKG_BG_PAYABLE_MAST_QRY" As

    Function fn_payable_mast(
        p_person_id   Varchar2,
        p_meta_id     Varchar2,

        p_payable_id  Varchar2 Default Null,
            ...
            From
                (
                    Select
                        ...
                        Row_Number() Over (Order By a.payableid Desc)       row_number,
                        Count(*) Over ()                                    total_row
                    From
                        bg_payable_mast                    a, bg_company_mast b
                    Where
                        a.compid        = b.compid
                        And a.payableid = nvl(p_payable_id, a.payableid)
    ...
    Procedure sp_payable_mast_details(
        p_person_id        Varchar2,
        p_meta_id          Varchar2,
    ...
    End sp_payable_mast_details;

End pkg_bg_payable_mast_qry;
/
Grant Execute On "TCMPL_AFC"."PKG_BG_PAYABLE_MAST_QRY" To "TCMPL_APP_CONFIG";