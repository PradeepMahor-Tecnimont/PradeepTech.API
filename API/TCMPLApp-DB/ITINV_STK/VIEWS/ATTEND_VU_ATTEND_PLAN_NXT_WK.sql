--------------------------------------------------------
--  DDL for View ATTEND_VU_ATTEND_PLAN_NXT_WK
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "ITINV_STK"."ATTEND_VU_ATTEND_PLAN_NXT_WK" ("WEEK_START_DATE", "WEEK_END_DATE", "KEYID", "EMPNO", "NAME", "PARENT", "ASSIGN", "GRADE", "DESKID", "DEVICE", "OFFICE", "FLOOR", "WING", "MON", "MON_IS_ABSENT", "MON_IS_ENABLE", "TUE", "TUE_IS_ABSENT", "TUE_IS_ENABLE", "WED", "WED_IS_ABSENT", "WED_IS_ENABLE", "THU", "THU_IS_ABSENT", "THU_IS_ENABLE", "FRI", "FRI_IS_ABSENT", "FRI_IS_ENABLE", "SAT", "SAT_IS_ABSENT", "SAT_IS_ENABLE") AS 
  SELECT
