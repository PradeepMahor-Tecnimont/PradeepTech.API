...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "TIMECURR"."DDD_27" ("YYMM", "EMPNO", "ASSIGN", "PROJNO", "ADJ", "ACTUAL_1", "ACTUAL_2", "ESTIMATE") AS 
  (
 ...
 nvl(d27,0)+nvl(d28,0)+nvl(d29,0)+nvl(d30,0)+nvl(d31,0) Estimate
 from time_daily 
 where yymm = '201806' and projno = '0979409'
 )
;
