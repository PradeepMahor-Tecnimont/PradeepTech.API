--------------------------------------------------------
--  DDL for View RAP_VU_RPT_WORKLOAD_01
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TIMECURR"."RAP_VU_RPT_WORKLOAD_01" ("YYMM", "PROJNO", "COSTCODE", "NAME", "PROJ_TYPE", "HRS") AS 
...
(nvl(rap_reports.getCummFutRecruit(costcode, rap_reports_gen.get_yymm_begin(yymm,'J'), yymm),0) * 
