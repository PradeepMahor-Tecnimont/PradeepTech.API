--------------------------------------------------------
--  DDL for View PRJ_CC_PO_RT_HRS_EXO
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TIMECURR"."PRJ_CC_PO_RT_HRS_EXO" ("PROJNO", "COSTCODE", "SAPCC", "YYMM", "TCMNO", "NAME", "TCM_CC", "PURCHASEORDER", "TCM_PHASE", "CCDESC", "HOURS", "OTHOURS", "TOTHOURS", "RATE", "e_ep_type") AS 
  (
 select projno,
        costcode,
        SAPCC,
