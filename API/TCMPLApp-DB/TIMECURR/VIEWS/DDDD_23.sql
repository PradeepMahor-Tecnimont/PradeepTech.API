--------------------------------------------------------
--  DDL for View DDDD_23
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TIMECURR"."DDDD_23" ("YYMM", "EMPNO", "ASSIGN", "PROJNO", "ADJ", "ACTUAL_1", "ACTUAL_2", "ESTIMATE_1", "ESTIMATE_2") AS 
  (
 (
 ...
 +nvl(d15,0)+nvl(d16,0)+nvl(d17,0)+nvl(d18,0)+nvl(d19,0)+nvl(d20,0)+nvl(d21,0)+nvl(d22,0)+nvl(d23,0),0) Actual_1,
 ...
 +nvl(d13,0)+nvl(d14,0)
 +nvl(d15,0)+nvl(d16,0)+nvl(d17,0)+nvl(d18,0)+nvl(d19,0)+nvl(d20,0)+nvl(d21,0)+nvl(d22,0)+nvl(d23,0),0) Actual_2 ,
 decode(wpcode,1,nvl(D24,0)+nvl(D25,0)+nvl(d26,0)+nvl(d27,0)+nvl(d28,0)+nvl(d29,0)+nvl(d30,0)+nvl(d31,0),0) Estimate_1,
 decode(wpcode,2,nvl(D24,0)+nvl(D25,0)+nvl(d26,0)+nvl(d27,0)+nvl(d28,0)+nvl(d29,0)+nvl(d30,0)+nvl(d31,0) , 0) Estimate_2
 from time_daily 
