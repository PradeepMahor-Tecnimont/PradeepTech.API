--------------------------------------------------------
--  DDL for Package Body PM_RND
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "TIMECURR"."PM_RND" AS
...
BEGIN
	...
	v_stmt := v_stmt || ' PM_RND.Get_emp_Name(TT.empno) Employee, ';
...
/* */
	 ...
	 v_stmt := v_stmt || ' PM_RND.Get_emp_Name(a.empno) Employee ,   ';
  ...
  v_stmt    VARCHAR2(1000) := NULL;
    ...
    BEGIN
        ...
        v_stmt := v_stmt || '       PM_RND.Get_total(''NT'',TT.yymm,TT.empno, TT.parent,TT.assign,''Proj'')NT_TOTAL , ';
        v_stmt := v_stmt || '       PM_RND.Get_total(''OT'',TT.yymm,TT.empno, TT.parent,TT.assign,''Proj'')OT_TOTAL , '; 
