--------------------------------------------------------
--  DDL for Package Body PKG_DB_AUTOBOOK_PREFERENCES_QRY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DESK_BOOK"."PKG_DB_AUTOBOOK_PREFERENCES_QRY" As
            ...
            From
                (
                    Select
                        ...
                        End booking_type
                    From
                        selfservice.ss_days_details                          d
                        Left Outer Join commonmasters.holidays              h
...
/
  ...
  GRANT EXECUTE ON "DESK_BOOK"."PKG_DB_AUTOBOOK_PREFERENCES_QRY" TO "TCMPL_APP_CONFIG";
