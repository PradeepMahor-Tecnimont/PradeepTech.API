--------------------------------------------------------
--  DDL for Package Body PKG_DB_AUTOBOOK_PREFERENCES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DESK_BOOK"."PKG_DB_AUTOBOOK_PREFERENCES" As
...
/
  ...
  GRANT EXECUTE ON "DESK_BOOK"."PKG_DB_AUTOBOOK_PREFERENCES" TO "TCMPL_APP_CONFIG";
