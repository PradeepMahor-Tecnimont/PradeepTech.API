--------------------------------------------------------
--  DDL for Package Body PKG_LOGBOOK_REPORT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "LOGBOOK1"."PKG_LOGBOOK_REPORT" As
    ...
    Begin
        ...
        Select userid
         ...
         Where empno = v_empno;
        v_filter_json := fn_gen_filter_json(p_proj_no, v_userid);
        ...
        End If;
        If p_message_type = 'OK' Then
            v_parameter_json := fn_gen_parameter_json(p_proj_no);
