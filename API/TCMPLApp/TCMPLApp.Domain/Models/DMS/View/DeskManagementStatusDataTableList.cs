...
{
    public class DeskManagementStatusDataTableList
    {
        ...
        [Display(Name = "Laptop1")]
        public string Nb1 { get; set; }

        [Display(Name = "Laptop Hostname1")]
        public string NbHostname1 { get; set; }

        [Display(Name = "Laptop Model1")]
        public string NbModel1 { get; set; }

        [Display(Name = "DocStn1")]
        public string Ds1 { get; set; }

        [Display(Name = "DocStn Model1")]
        public string DsModel1 { get; set; }
        ...
        [Display(Name = "Laptop2")]
        public string Nb2 { get; set; }

        [Display(Name = "Laptop Hostname2")]
        public string NbHostname2 { get; set; }

        [Display(Name = "Laptop Model2")]
        public string NbModel2 { get; set; }

        [Display(Name = "DocStn2")]
        public string Ds2 { get; set; }

        [Display(Name = "DocStn Model2")]
        public string DsModel2 { get; set; }
        ...
        [Display(Name = "Desk Doc. Stn")]
        public string DeskDckStn { get; set; }

        [Display(Name = "Desk Doc. Stn. Model")]
        public string DeskDckStnModel { get; set; }
    }
}