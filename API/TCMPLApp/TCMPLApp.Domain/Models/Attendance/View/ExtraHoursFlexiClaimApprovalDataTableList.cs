...
{
    public class ExtraHoursFlexiClaimApprovalDataTableList
    {
        ...
        [Display(Name = "Employee")] // EmpNo - EmpName
        public string Employee { get; set; }

        [Display(Name = "Parent")] // EmpNo - EmpName
        ...
        public string PenaltyHrs { get; set; }
