...
namespace TCMPLApp.Library.Excel.Charts
{
    public class MSSample
    {
        ...
        {
            string docName = @"C:\myTemp\Book1.xlsx";
        ...
        private static void InsertChartInSpreadsheet(string docName, string worksheetName, string title, Dictionary<string, int> data)
        {
